...
<body>
    <header>
        <div>
            ...
            <ul>
                ...
                <li>
                    <a href="../exhibition/preference-search">내 취향 전시 찾기</a>
                </li>
    ...
    <div class="main-container">
        ...
        <div id="myBtnContainer" style="width: 1440px; margin: auto;">
            ...
            <!--  
            <button class="btn" onclick="filterSelection('cars')" value="">전시회</button>
            <button class="btn" onclick="filterSelection('animals')" value="">팝업</button>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			<c:forEach var="theme" items="${themeList}" varStatus="status">
			//테마 클릭했을 때
			$("#fBtnC${status.count}").on("click", function(e) {
				var theme_no = $("#fBtnC${status.count}").val();

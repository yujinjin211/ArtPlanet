...
<body>
    ...
    <div style="width: 1440px; margin: auto; height: 1500px; padding-top: 60px;">
        ...
        <div>
	        <form name="pwCheckForm" class="login-form" action="./userCheck" method="post">
	        	<input type="hidden" name="id" value="${user.id }" >
	            <h1 style="text-align: center; padding-bottom: 20px;">비밀번호 확인</h1>
	          <div class="login-container">
	            <label for="password"><b>비밀번호를 입력해주세요.</b></label>

...
<body>
    ...
    <div class="main-content" style="height: 1500px;">
        <div class="sidebar" style="float: left; width: 200px;">
            ...
            <a href="visit-exhibition.html">다녀온 전시 목록</a>
        ...
        <div class="content">
            <div class="wrapper">
                <div class="card">
                    <img src="images/non300-1.jpg">
                    <div class="wrapper-container">
                        <a id="wc-a"><i class="fa-regular fa-heart" style="font-size: x-large;"></i></a>
                        <p><a href="exhibition-detail.jsp" style="font-size: large; text-decoration-line: none; color: #444;"><b>전시이름</b></a></p>
                        <a>지역</a> /
                        <a>주제</a> /
                        <a>요금</a>
                        <p><a>전시장소명</a></p>
